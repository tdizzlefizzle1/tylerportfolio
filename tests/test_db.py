...
class TestTimelinePost(unittest.TestCase):
    ...
    def tearDown(self):
        # Not necessary since SQLite in-memory db only lives for the duration of the connection,
        # and in the next step, we close the connection, but still good practice
